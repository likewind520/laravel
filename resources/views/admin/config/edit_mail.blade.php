                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('admin.config.update',['name'=>$name])}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="MAIL_DRIVER" value="{{$config['data']['MAIL_DRIVER']}}" class="form-control" id="exampleInputEmail1" placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">主机</label>
                                <input type="text" name="MAIL_HOST" value="{{$config['data']['MAIL_HOST']}}" class="form-control" id="exampleInputEmail1" placeholder="">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">端口</label>
                                <input type="text" name="MAIL_PORT" value="{{$config['data']['MAIL_PORT']}}" class="form-control" id="exampleInputEmail1" placeholder="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="MAIL_PASSWORD" value="{{$config['data']['MAIL_PASSWORD']}}" class="form-control" id="exampleInputEmail1" placeholder="">
                            </div>
                            <div class="form-group">
